...
Flippy = 'Donald Frump'
lTheBrrrgh = 'The Cold'
lDaisyGardens = 'Gardens'
lDonaldsDock = "Donut's Dock"
lDonaldsDreamland = "Donut's Dreamland"
...
GlobalStreetNames = {20000: ('to', 'on', 'Tutorial Terrace'),
 ...
 13000: ('to the', 'in the', 'Law HQ Courtyard'),
...
TipDict = {TIP_NONE: ('',),
 ...
 TIP_COGHQ: ('You must complete your Karen Disguise before visiting the V.P.',
             ...
             "It pays to be puzzled: the virtual Cogs in Law HQ won't reward you with Jury Notices."),
